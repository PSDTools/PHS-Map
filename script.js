...
function start() {
	$.get('https://raw.githubusercontent.com/ParkerH27/PHS-Map/main/Level1.txt', function(data) {
		gridLvl1 = JSON.parse(data)
	});
	$.get('https://raw.githubusercontent.com/ParkerH27/PHS-Map/main/Level2.txt', function(data) {
